...
`].filter(Po).join(`
`)),o=Ou(o),o=Vf(o,t),o=zf(o,t),a=Ou(a),a=Vf(a,t),a=zf(a,t),o=Gf(o),a=Gf(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`;pd(JR);const I_="feedback-comb-filter",eI=`
...
vec3 transformedNormal = normalMatrix * (basis * rotMat * objectNormal);
	...
	`);i.vertexShader=r})}constructor(e,t,n,i,r=void 0){let o=c=>{const l=new Qn(c.geometry.clone(),c.material.clone(),i);return l.name=c.name,l.material.vertexColors=!0,l.frustumCulled=!1,l.count=0,l},a;Array.isArray(t)?(a=[],t.forEach(c=>{a.push(o(c))})):a=o(t),super(a,r),this.cell_count=e;for(let c=0;c<e;c++)this.clearInstanceIdsAt(c)}clearInstanceIdsAt=e=>{let t=(n,i)=>{n.userData.indexDictionary===void 0&&(n.userData.indexDictionary=new Array(this.cell_count)),n.userData.indexDictionary[i]===void 0&&(n.userData.indexDictionary[i]={id:[]}),n.count-=n.userData.indexDictionary[i].id.length,n.userData.indexDictionary[i].id=[]};Array.isArray(this.object3D)?this.object3D.forEach(n=>{t(n,e)}):t(this.object3D,e)};updateInstancesAt=(e,t)=>{let n=i=>{i.userData.indexDictionary===void 0&&(i.userData.indexDictionary=new Array(this.cell_count)),i.userData.indexDictionary[e]===void 0&&(i.userData.indexDictionary[e]={id:[]}),i.userData.indexDictionary[e].id.push(t.clone()),i.count++};Array.isArray(this.object3D)?this.object3D.forEach(i=>{n(i)}):n(this.object3D)};fillInstanceData=()=>{let e=t=>{let n=0;for(let i=0;i<t.userData.indexDictionary.length;i++){const r=t.userData.indexDictionary[i].id;for(let o=0;o<r.length;o++)t.setMatrixAt(n,r[o]),n++}t.instanceMatrix.needsUpdate=!0};Array.isArray(this.object3D)?this.object3D.forEach(t=>{e(t)}):e(this.object3D)};updatePerPlacingIndex=e=>{this.clearInstanceIdsAt(e),this.updateInstancesAt(e),this.fillInstanceData()}}class kI extends vs{modifyShader(e,t,n=1){e.__ok||(e.__ok=!0,e.onBeforeCompile=i=>{if(i.__modified)return;i.__modified=!0,Object.assign(i.uniforms,t);const r={bomb_colors:{value:[1,1,1,1,1,0,1,0,0]}};Object.assign(i.uniforms,r);const o=`
    ...
    vec4(10.0/16.0, 06.0/16.0, 09.0/16.0, 05.0/16.0));
       ...
       /*     for (int i=0;i<samples;i++) {
		...
		}`};new P;const Tu=new Ue,uc=new P(0,0,1),nm=new P(0,0,0),zs=new P,KI=(s,e,t)=>{nm.set(0,0,0);let n=s.geometry.level.instancedMatrices[t].clone();uc.set(0,1,0);let i=uc.applyMatrix4(n);zs.setFromMatrixPosition(n),zs.add(i.multiplyScalar(-.08)),n.setPosition(zs);const r=s.geometry.level.offsets[e];s.Curve.getTBNAt(r,Tu),uc.set(0,0,1),i=uc.applyMatrix4(n);const o=nm.applyMatrix4(n);return o.applyMatrix4(Tu),i.applyMatrix4(Tu),i.sub(o),i.normalize(),{origin:o,direction:i}},ZI=(s,e,t,n)=>{zs.subVectors(s,t);const i=e.dot(e),r=2*zs.dot(e),o=zs.dot(zs)-n*n,a=r*r-4*i*o;return a<0?-1:(-r-Math.sqrt(a))/(2*i)},QI=s=>{let e=(i,r)=>{const o=i.id_on_beat;i.instrument,i.effect;const a=KI(s,r%s.GlobalParameters.barSize,o),c=ZI(a.origin,a.direction,s.camera.position,.2);c!==-1&&c<1&&(s.AudioSystem.playInstrumentAt(i,c),i.played_at=r)};const t=s.Curve.getCurrentCell(1),n=t%s.GlobalParameters.barSize;return s.AudioSystem.melody[n].instances.forEach(i=>{i.played_at!==t&&e(i,t)}),s};new P;new Ue;new P;const hc=[],JI=new P,eD=new Te,tD=new Te;let Cs=-1;const nD=s=>{if(Cs<0&&s.hand.userData.removeFinger===!0&&s.fingersAlive>0){s.hand.userData.removeFinger=!1,s.AudioSystem.playEmptyInstrument(),s.hand.children[0].material.color.set(1,0,0),Cs=0,s.hand.userData.fingers_bones[s.fingersAlive-1].scale.set(0,0,0);const t=s.hand.userData.fingers[s.fingersAlive-1];t.bindMode="detached",hc.push(t),console.log(t.rotation),console.log(t.position),t.visible=!0,t.userData.fallDirection=JI.set(Math.random()*2-1,Math.random()*2-1,-Math.random()*.5).normalize().clone().multiplyScalar(20),s.fingersAlive--}return Cs>=0&&(s.hand.children[0].material.color.lerpColors(eD.set(1,0,0),tD.set(1,1,1),Math.sin(Cs*20)*.5+.5),Cs+=s.time.delta,Cs>s.GlobalParameters.safeTime&&(Cs=-1,s.hand.userData.removeFinger=!1,s.hand.children[0].material.color.set(1,1,1))),hc.length>0&&hc.forEach((e,t)=>{e.rotateX(.1),e.rotateZ(.1),e.position.add(e.userData.fallDirection.clone().multiplyScalar(s.time.delta)),e.scale.subScalar(s.time.delta/2),e.scale.x<.01&&(e.visible=!1,s.scene.remove(e),hc.splice(t,1))}),s},iD=s=>(s.fingersAlive===0&&(console.log("U DED"),s.paused=!0,s.showEndScreen(!0)),s),sD=s=>{if(s.progressMustUpdate===!0){let e=document.getElementById("progressbar_position");e.style.width=Math.floor(s.AudioSystem.getProgress()*100)+"%",s.progressMustUpdate=!1,s.AudioSystem.getProgress()>=1&&(s.win=!0,s.geometry.interactives.forEach(t=>{for(let n=0;n<s.Curve.curveLength;n++)t.clearInstanceIdsAt(n)})),console.log("progressSystem",s.AudioSystem.getProgress()*100)}return s};function rD(s,e,t){const n=[...s];var i=t>n.length?t%n.length:t;return n.concat(n.splice(0,e>0?n.length-i:i))}class oD{timer=0;global_timer=0;visual_step=.1;done=!1;initialized=!1;constructor(e){this.duration=e}initialize(e){if(this.initialized!==!0){this.timer=this.global_timer=0,this.done=!1,e.GlobalParameters.rotationSpeed.value=.1;for(let t=0;t<e.AudioSystem.melodyInstrumentID.length;t++)e.AudioSystem.melodyInstrumentID[t]===4&&e.AudioSystem.melodyInstrumentID.eventOnModify(t,t/40/2%4);this.initialized=!0}}cleanup(e){e.GlobalParameters.triAmplitude.value=1,e.GlobalParameters.rotationSpeed.value=0}play(e){if(this.timer>this.visual_step){const t=rD(e.AudioSystem.melodyInstrumentID,1,40);for(let n=0;n<e.AudioSystem.melodyInstrumentID.length;n++)e.AudioSystem.melodyInstrumentID.eventOnModify(n,t[n]);this.timer=0}this.timer+=e.time.delta,this.global_timer+=e.time.delta,this.global_timer>this.duration&&(this.done=!0,this.initialized=!1,this.global_timer=0),this.global_timer>5&&(e.GlobalParameters.triAmplitude.value=(this.global_timer-5)/2.5*((this.global_timer-5)/2.5),e.GlobalParameters.rotationSpeed.value=Math.sqrt(this.global_timer-5)/2)}}let dc=new oD(15.5);const aD=s=>(s.win===!0&&!s.paused&&(dc.initialized||dc.initialize(s),dc.play(s),dc.done&&(s.win=!1,s.paused=!0,s.showWinScreen(!0))),s);class cD{world;#e;#t;#n=new Xo;#h=!1;constructor(e){this.world=rE(),this.world.songEditingUnlocked=!1,this.world.editMode=!1,this.world.paused=!0,this.world.progressMustUpdate=!1,this.world.win=!1,this.world.GlobalParameters={speed:2.5,curveCount:3,curveLength:8,barSize:8,loops:1,safeTime:2,rotationSpeed:{value:0},triAmplitude:{value:1}},this.world.Input=new lE(this.world.renderer.domElement),this.world.Curve=new BI(this.world.GlobalParameters.curveCount,this.world.GlobalParameters.curveLength,this.world.GlobalParameters.barSize*this.world.GlobalParameters.loops),this.world.AudioSystem=new xI(this.world.GlobalParameters.barSize),e!==void 0&&(this.#s(e),this.world.scene.add(this.#n)),this.#l(),this.#u(),this.#e=iE(SI,this.world.Curve.curveSystem,this.world.Curve.updateGeometry,EI,AI,CI,zI,nD,iD,sD,aD,QI,MI)}#l(){const e=Tp(this.world);wp(this.world.camera,e),ec(this.world,to,e),ec(this.world,Sg,e),this.world.objects.set(this.world.camera.eid,this.world.camera),this.world.camera.userData.speed=this.world.GlobalParameters.speed,this.world.camera.userData.dirV=new P(0,0,-1),this.world.camera.userData.offset=new P(0,0,0);const t=new Kt(new wh(1e-4,32,32),new ci({color:65280}));this.world.scene.add(new jb(5)),this.world.scene.add(new ag(16777215,.05)),this.world.scene.add(t);let n=new rg(16777215,3);n.position.set(0,0,.5),n.angle=3.14/4,n.decay=2,n.distance=30,n.penumbra=0,n.target=this.world.camera,n.castShadow=!1,this.world.camera.add(n),this.world.scene.add(this.world.camera),this.world.composer=new XI(this.world.renderer);const i=new qI(this.world.scene,this.world.camera);this.world.composer.addPass(i);const r=new L_($I);r.uniforms.time={value:0},this.world.composer.addPass(r);const o=new YI;o.material.defines.ACES_FILMIC_TONE_MAPPING=!0,this.world.composer.addPass(o)}update(){this.world.Input.update(),this.world.composer.passes[1].uniforms.time.value=this.world.time.elapsedTime,this.#e(this.world)}#u(){}#s(e){new lg().setPath("/models/");let t,n=[],i=[],r,o,a,c;e.traverse(function(O){O.name.includes("TO_SELF")?t=O:O.name.includes("TO1")?n.push(O):O.name.includes("VISUAL_QUAD")?r=O:O.name.includes("HAND")?o=O:O.name.includes("ELECTRICITY")?a=O:O.name.includes("BOMB")&&(c=O),O.name.includes("knobs")&&(O.updateMatrixWorld(),i.push(O.matrixWorld))});const l=this.world.GlobalParameters.loops*this.world.GlobalParameters.barSize;this.world.geometry={},this.world.geometry.level=[],this.world.geometry.level=new NI(l,i),this.world.geometry.level.addObject(P_,n,{activeEffectID:{value:this.world.AudioSystem.activeEffectID},barLoops:{value:this.world.GlobalParameters.loops},rotationSpeed:this.world.GlobalParameters.rotationSpeed,triAmplitude:this.world.GlobalParameters.triAmplitude}).object3D.forEach(O=>{this.#n.add(O)});const h=this.world.geometry.level.addObject(OI,t,{melodyInstrumentID:{value:this.world.AudioSystem.melodyInstrumentID},rotationSpeed:this.world.GlobalParameters.rotationSpeed,triAmplitude:this.world.GlobalParameters.triAmplitude});this.#n.add(h.object3D),t.material.emissiveIntensity=.5,t.material.emissiveMap=t.material.map,t.material.emissive=t.material.color;const d=this.world.geometry.level.addObject(UI,r,{melodyInstrumentID:{value:this.world.AudioSystem.melodyInstrumentID},melody:{value:this.world.AudioSystem.melody},rotationSpeed:this.world.GlobalParameters.rotationSpeed});d.object3D.position.set(0,-.2,-.08),d.object3D.scale.set(1.25,1.25,1.25),this.#n.add(d.object3D);for(let O=0;O<l;O++){const{curveIndex:j,u:B}=this.world.Curve.getCurveIndexAndUAt(.5+O);this.world.geometry.level.moveGeometryForward(O,B,j)}this.world.geometry.interactives=[],n.forEach(O=>{const j=new oh(this.world.GlobalParameters.curveCount,O,O.material,100);this.world.geometry.interactives.push(j),this.#n.add(j.object3D)});const f=new oh(this.world.GlobalParameters.curveCount,t,t.material,400,vu);this.world.geometry.interactives.push(f),this.#n.add(f.object3D);const m=new FI(this.world.GlobalParameters.curveCount,a,a.material,400,vu);this.world.geometry.interactives.push(m),this.#n.add(m.object3D);const _=new kI(this.world.GlobalParameters.curveCount,c,c.material,400,vu);this.world.geometry.interactives.push(_),this.#n.add(_.object3D);const g=o.animations[0],p=[];g.tracks.forEach((O,j)=>{O.name.includes("scale")&&p.push(j)});for(let O=p.length;O>0;O--)g.tracks.splice(p[O-1],1);const x=g.tracks[0].times.length/g.duration;ws.makeClipAdditive(g);const v=ws.subclip(g,"IDLE",0,1,x),M=ws.subclip(g,"LEFT",2,3,x),y=ws.subclip(g,"RIGHT",4,5,x),b=ws.subclip(g,"UP",6,7,x),E=ws.subclip(g,"DOWN",8,9,x),T=ws.subclip(g,"MOVING",10,34,x);o.position.set(0,-0,-.2),o.rotation.set(0,0,0),o.scale.set(.01,.01,.01),o.userData.fingers_bones=[o.getObjectByName("middle_01_l"),o.getObjectByName("thumb_02_l"),o.getObjectByName("index_01_l"),o.getObjectByName("ring_01_l"),o.getObjectByName("pinky_01_l")],o.userData.fingers=[o.getObjectByName("heroBodymiddle"),o.getObjectByName("heroBodythumb"),o.getObjectByName("heroBodyindex"),o.getObjectByName("heroBodyring"),o.getObjectByName("heroBodypinky")],o.userData.storedFingerData=[],o.userData.fingers.forEach(O=>{o.userData.storedFingerData.push({position:O.position.clone(),rotation:O.rotation.clone(),scale:O.scale.clone()})}),this.world.fingersAlive=o.userData.fingers.length,o.userData.fingers.forEach(O=>{O.visible=!1}),o.userData.removeFinger=!1,this.world.mixer=new Xb(o),this.world.hand=o;const S=Tp(this.world);wp(o,S),ec(this.world,to,S),ec(this.world,Mg,S),this.world.objects.set(o.eid,o);const w=this.world.mixer.clipAction(v),N=this.world.mixer.clipAction(M),F=this.world.mixer.clipAction(y),V=this.world.mixer.clipAction(E),C=this.world.mixer.clipAction(b),U=this.world.mixer.clipAction(T);U.loop=Rm;function k(O,j){O.enabled=!0,O.setEffectiveTimeScale(1),O.setEffectiveWeight(j)}this.world.hand_actions=[w,N,F,V,C,U],this.world.hand_actions.forEach(O=>{k(O,0),O.play()}),k(U,1),this.#n.add(o)}resetGameState(){this.world.win=!1,this.world.GlobalParameters.rotationSpeed.value=0,this.world.GlobalParameters.triAmplitude.value=1,this.world.hand.userData.fingers.forEach((e,t)=>{e.position.copy(this.world.hand.userData.storedFingerData[t].position),e.rotation.copy(this.world.hand.userData.storedFingerData[t].rotation),e.scale.copy(this.world.hand.userData.storedFingerData[t].scale),e.visible=!1}),this.world.hand.userData.fingers_bones.forEach(e=>{e.scale.set(1,1,1)}),this.world.hand.userData.removeFinger=!1,this.world.fingersAlive=5,this.world.AudioSystem.resetMelody(),this.world.Curve.resetCurves(this.world),this.world.progressMustUpdate=!0,this.world.camera.position.set(0,0,0)}}const im={type:"start"},lD={type:"end"};class uD extends qi{constructor(e){super(),new xe(0,1),new xe(0,-1),new xe(1,0),new xe(-1,0),this.domElement=e,this.domElement.style.touchAction="none";const t=this;this.current_input=bg,this.touches={ONE:vc.MOVE,TWO:vc.DOLLY_PAN};const n=[],i={},r={NONE:-1,MOVE:0};let o=r.NONE,a=!1,c=window.innerWidth/2,l=window.innerHeight/2,u=window.innerWidth/2,h=window.innerHeight/2,d=0,f=0;this.update=function(C){this.current_input.diffX=d/t.domElement.clientWidth,this.current_input.diffY=f/t.domElement.clientHeight,this.current_input.startX=u/t.domElement.clientWidth*2-1,this.current_input.startY=-(h/t.domElement.clientHeight)*2+1,this.current_input.pointerX=c/t.domElement.clientWidth*2-1,this.current_input.pointerY=-(l/t.domElement.clientHeight)*2+1,this.current_input.mouseMove=a,d=f=0};function m(C,U,k){const O=C.getBoundingClientRect(),j=U-O.left,B=k-O.top;return{x:j,y:B}}function _(C){let U=i[C.pointerId];U===void 0&&(U=new xe,i[C.pointerId]=U),U.set(C.pageX,C.pageY)}function g(C){switch(_(C),n.length){case 1:if(t.enableRotate===!1)return;p(),o=r.MOVE;break;case 2:switch(t.touches.TWO){default:o=r.NONE}break;default:o=r.NONE}o!==r.NONE&&t.dispatchEvent(im)}function p(){if(n.length===1){const{x:C,y:U}=m(t.domElement,n[0].pageX,n[0].pageY);c=C,u=C,l=U,h=U}}function x(C){switch(_(C),o){case r.MOVE:if(t.enableRotate===!1)return;v(C);break;default:o=r.NONE}}function v(C){if(n.length===1){a=!0;const{x:U,y:k}=m(t.domElement,C.pageX,C.pageY);U<c?d=c-U:U>c&&(d=U-c),d=U-c,k<l?f=l-k:k>l&&(f=k-l),f=k-l,c=U,l=k}}let M=On.None;function y(C){switch(C.button){case 0:M=On.LEFT,b(C);break;case 1:M=On.MIDDLE;break;case 2:M=On.RIGHT;break;default:M=-1}o!==r.NONE&&t.dispatchEvent(im)}function b(C){const{x:U,y:k}=m(t.domElement,C.pageX,C.pageY);c=U,l=k,u=U,h=k}function E(C){if(t.enabled!==!1)switch(M){case On.LEFT:if(t.enableZoom===!1)return;T(C);break;case On.MIDDLE:if(t.enablePan===!1)return;handleMouseMovePan(C);break}}function T(C){a=!0;const{x:U,y:k}=m(t.domElement,C.pageX,C.pageY);U<c?d=c-U:U>c&&(d=U-c),d=U-c,k<l?f=l-k:k>l&&(f=k-l),f=k-l,c=U,l=k}function S(C){n.push(C)}function w(C){delete i[C.pointerId];for(let U=0;U<n.length;U++)if(n[U].pointerId==C.pointerId){n.splice(U,1);return}}function N(C){t.enabled!==!1&&(n.length===0&&(C.target.setPointerCapture(C.pointerId),t.domElement.addEventListener("pointermove",F),t.domElement.addEventListener("pointerup",V)),S(C),C.pointerType==="touch"?g(C):y(C))}function F(C){t.enabled!==!1&&(C.pointerType==="touch"?x(C):E(C))}function V(C){w(C),n.length===0&&(C.target.releasePointerCapture(C.pointerId),t.domElement.removeEventListener("pointermove",F),t.domElement.removeEventListener("pointerup",V)),t.dispatchEvent(lD),M=-1,a=!1,d=0,f=0}t.domElement.addEventListener("pointerdown",N,!1),t.domElement.addEventListener("pointercancel",V,!1)}init(e){}execute(e,t){this.checkGameKeys()}}let O_=!1;const bn=document.getElementById("musicSheet"),kn=document.getElementById("musicSheetContainer"),Wn=document.getElementById("slider"),la=document.getElementById("slider_position"),sm=document.getElementById("sheetMenu"),rm=document.getElementById("sheet_tooltips"),om=document.getElementById("scale-div"),U_=document.getElementById("synth-name"),Os=document.getElementById("e-list"),hD=document.getElementById("sheet_songList"),Eu=[28,38,29,39,20,30,21,31,22,32,23,33,24,34,25,35,26,36,27,37],wu=[18,17,16,13,12,11,10,8,7,6,5,3,4,2,9,14,15,1,0,19],Ln=[.05,.2,.6,.1,.6,.3,.5,.5,.65,.7,.1,.1,.05,.05,.05],ii=new Xo;ii.background=new Te(3355443);const Ft=10;[bn.width,bn.height]=[window.innerWidth,window.innerHeight];let Ui,pn,pt;bn.width*=.95,bn.height*=.95,pn=bn.width/bn.height,pn>1&&(pn=8/10),bn.width=bn.height*pn,Ui=new da(pn*Ft/-2,pn*Ft/2,Ft/2,Ft/-2,1,1e3),Ui.position.y=-.1,Ui.position.z=5,Ui.position.y=-2.5,Ui.lookAt(0,0,0);la.style.width=`${pn/.804*100}%`;const Wr=1-pn/.804;document.getElementById("sheetMenu").style.width=`${bn.width}px`;So(!1);let bl=new Sh({canvas:bn,antialias:!0,alpha:!0});bl.shadowMap.enabled=!0;bl.shadowMap.type=pm;let Dn;const $t={},am=new qb,Yt=new xe,Mn=new xe;new xe;const dD=new xe;new xe;const Xi=[],ah=[];let Cr=[],zt,cm,Rt;const lm={instrument:0,pitch:10};let Pn=[],um=0;const hm=new uD(kn);kn.addEventListener("pointerdown",ch,!1);Wn.addEventListener("pointerdown",fD,!1);function yd(s,e,t){const n=s.getBoundingClientRect(),i=e.clientX-n.left,r=e.clientY-n.top;t.set(i,r)}function ch(s){kn.addEventListener("pointerup",F_),yd(kn,s,Yt),dD.copy(Yt),Yt.x=Yt.x/kn.clientWidth*2-1,Yt.y=-Yt.y/kn.clientHeight*2+1}function F_(s){if(kn.releasePointerCapture(s.pointerId),pt!==void 0&&Rt!==void 0&&Rt!==4){const e=zt.AudioSystem.instruments[Rt];e.modifyParameter(pt.userData.parameter.name,pt.userData.parameter.value),lm.instrument=Rt,console.log("playing note ",e),zt.AudioSystem.playInstrumentAt(lm)}pt=void 0,kn.removeEventListener("pointerup",F_)}function fD(s){Wn.addEventListener("pointerup",k_),Wn.addEventListener("pointermove",B_),yd(Wn,s,Mn);const e=la.getBoundingClientRect();let t=(e.right-e.left)/2;t=t/Wn.clientWidth,console.log(t),Mn.x=Mn.x/Wn.clientWidth;let n=Mn.x-t;Mn.x=Math.max(0,Math.min(Wr,Mn.x)),n=Math.max(0,Math.min(Wr,n));for(let i=0;i<Xi.length;i++){const r=Xi[i];r.position.x=r.userData.cachedXPos-n*Ft/1.23}la.style.transform=`translateX(${n*100/(1-Wr)}%)`,console.log(Mn)}function k_(s){Wn.releasePointerCapture(s.pointerId),Wn.removeEventListener("pointermove",B_),Wn.removeEventListener("pointerup",k_)}function B_(s){yd(bn,s,Mn);const e=la.getBoundingClientRect();let t=(e.right-e.left)/2;t=t/Wn.clientWidth,console.log(t),Mn.x=Mn.x/Wn.clientWidth;let n=Mn.x-t;Mn.x=Math.max(0,Math.min(Wr,Mn.x)),n=Math.max(0,Math.min(Wr,n));for(let i=0;i<Xi.length;i++){const r=Xi[i];r.position.x=r.userData.cachedXPos-n*Ft/1.23}la.style.transform=`translateX(${n*100/(1-Wr)}%)`}function V_(s,e,...t){s.utils_modified||(s.utils_modified=!0,s.onBeforeCompile=n=>{if(n._utils_modified)return;n._utils_modified=!0,Object.assign(n.uniforms,e);const i=`
				attribute int instanceID;
				/*attribute int flowID;*/
				attribute int melodyInstrumentID;
				uniform sampler2D spineTexture;
...
uint hash( uint x ) {
	...
	`);n.vertexShader=i})}function sl(s,e,t,n){s.setAttribute(e.toString(),new wc(new Int32Array(t),n)),s.attributes[e.toString()].setUsage(mh),s.attributes[e.toString()].needsUpdate=!0}let dm=(s,e,t)=>{const n=new Qn(s.geometry.clone(),s.material.clone(),e.length);n.name=s.name,n.material.vertexColors=!0,n.frustumCulled=!1,sl(n.geometry,"instanceID",40,1),sl(n.geometry,"melodyInstrumentID",40,1);for(let i=0;i<e.length;i++)n.geometry.attributes.instanceID.array[i]=i+t*40,n.setMatrixAt(i,e[i]),n.geometry.attributes.melodyInstrumentID.array[i]=$t.melodyInstrumentID.value[i];return n.geometry.attributes.instanceID.needsUpdate=!0,n.geometry.attributes.melodyInstrumentID.needsUpdate=!0,$t.picked={value:-1},V_(n.material,$t),n},pD=(s,e)=>{const t=new Qn(s.geometry.clone(),s.material.clone(),e.length);t.name=s.name,t.material.vertexColors=!0,sl(t.geometry,"instanceID",e.length,1),sl(t.geometry,"melodyInstrumentID",e.length,1);for(let n=0;n<e.length;n++)t.geometry.attributes.instanceID.array[n]=n-40,t.setMatrixAt(n,e[n]),t.geometry.attributes.melodyInstrumentID.array[n]=(n+4)%4;return t.instanceMatrix.needsUpdate=!0,t.geometry.attributes.instanceID.needsUpdate=!0,t.geometry.attributes.melodyInstrumentID.needsUpdate=!0,V_(t.material,$t),t};function mD(s,e){zt=e,$t.melodyInstrumentID={value:e.AudioSystem.melodyInstrumentID},$t.time={value:0};let t=[],n,i=[],r,o=[],a;new ci({color:65280}),s.traverse(function(T){T.name.includes("TO_SELF")?Dn=T:T.name.includes("TO1")&&Cr.push(T),T.name.includes("Node")&&(n=T),T.parent!==null&&T.parent.name.includes("sheet_positions")&&T.name.includes("TO_")&&(T.name.includes("TO_position1")&&(r=T),T.updateMatrixWorld(),i.push(T.matrixWorld.clone())),T.name.includes("knob_")&&(T.updateMatrixWorld(),o.push(T.matrixWorld)),T.name.includes("mixer")&&(T.updateMatrixWorld(),a=T,a.userData.skipInteraction=!0),T.name.includes("bezier")&&(T.updateMatrixWorld(),Pn.push(T))}),n.children.forEach(T=>{T.updateMatrixWorld(),T.matrixWorld.elements[14]=+T.name.slice(-(T.name.length-3)),t.push(T.matrixWorld),T.material=new Ds({color:16777215})}),t.sort((T,S)=>{if(T.elements[14]>S.elements[14])return 1;if(T.elements[14]<S.elements[14])return-1;if(T.elements[14]===S.elements[14])return 0}),t.forEach(T=>{T.elements[14]=0}),Dn.material=Dn.material.clone(),Dn.material.emissivemap=void 0,Dn.material.emissiveColor={r:0,g:0,b:0},Dn.material.emissiveIntensity=0,Dn.material.vertexColors=!0,Dn.geometry.computeBoundingBox();var c=new cl(Ft*2,Ft*2,2,2);const l=Cr[0].material.map.clone();l.wrapS=mn,l.wrapT=mn,l.repeat=new xe(3.5,3.5);const u=4;var h=new ci({color:new Te(Ln[u*3+0],Ln[u*3+1],Ln[u*3+2]).multiply(new Te(.5,.5,.5)),map:l}),d=new Kt(c,h);d.userData.skipInteraction=!0,d.position.z=-1,ii.add(d),ii.add(new ag(16777215,.5));const f=new og(16777215,2);f.castShadow=!0,f.name="DIRLIGHT",f.shadow.mapSize.width=512,f.shadow.mapSize.height=512,f.shadow.camera.near=0,f.shadow.camera.far=1e3,f.shadow.camera.position.copy(Ui.position),f.position.set(50,50,50),ii.add(f);const m=dm(Dn,t,0);m.position.set(-Ft*pn/2+.75,Ft/2+.35),m.setRotationFromAxisAngle(new P(0,0,1),-3.14/2),m.userData.beat=0,m.userData.cachedXPos=m.position.x,Xi.push(m),ii.add(m);for(let T=1;T<e.GlobalParameters.barSize;T++){const S=dm(Dn,t,T);S.position.set(-Ft*pn/2+.75+T,Ft/2+.35,0),S.setRotationFromAxisAngle(new P(0,0,1),-3.14/2),S.userData.beat=T,S.geometry.attributes.melodyInstrumentID.needsUpdate=!0,S.userData.cachedXPos=S.position.x,Xi.push(S),ii.add(S);for(let w=0;w<40;w++)S.geometry.attributes.melodyInstrumentID.array[w]=$t.melodyInstrumentID.value[T*40+w]}-Ft*pn/2+.75+e.GlobalParameters.barSize-1;let _=2.5;new Array(4).fill(0).map((T,S)=>{const w=new Ue;return w.compose(new P(-Ft*pn/2+.25*_+S*.27*_,-Ft/2+1.5,0),new Ht().setFromAxisAngle(new P(0,0,1),S*3.14),new P(_,_,_)),w});const g=new vt;r.material=Dn.material.clone();const p=pD(r,i);p.receiveShadow=!0,p.name=Dn.name,p.userData.beat=-1,g.add(p),a.castShadow=!1,g.add(a);const x=Pn[0];Pn[0]=Pn[1],Pn[1]=x;for(let T=0;T<Pn.length;T++)Pn[T].visible=!1,Pn[T].userData.skipInteraction=!0,Pn[T].castShadow=!0,g.add(Pn[T]);const v=3;for(let T=0;T<o.length;T++){const S=new P().setFromMatrixPosition(o[o.length-T-1]),w=Math.floor(Math.random()*(Cr.length-1))+1;console.log(Cr.length),console.log(w);const N=Cr[w].clone();N.material=Cr[w].material.clone(),N.rotateX(3.14/2),N.position.copy(S),N.material.color=new Te(Ln[(T*3+v)%(Ln.length-3)],Ln[(T*3+1+v)%(Ln.length-3)],Ln[(T*3+2+v)%(Ln.length-3)]),N.userData.knob=T+1,N.userData.color=T+v,N.castShadow=!0,N.recieveShadow=!1;const F=.8;N.scale.set(F,F,F),N.updateMatrixWorld(),ah.push(N),g.add(N)}g.castShadow=!0,g.receiveShadow=!0;const M=Ft*pn/1.85;g.scale.set(M,M,M);let y=new $n;g.traverse(T=>{if(T.geometry){const S=new $n;T.geometry.computeBoundingBox(),S.copy(T.geometry.boundingBox).applyMatrix4(T.matrixWorld)}}),y.setFromObject(g);const b=new P,E=new P;new P,y.getSize(b),y.getCenter(E),g.position.y=-Ft/2-E.y+b.y/2+M/8,g.position.x+=-Ft*pn/2-E.x+b.x/2,ii.add(g),a.receiveShadow=!0,bl.render(ii,Ui)}function gD(){if(!O_||hD.style.display!=="none")return;if(hm.update(),Yt.x,pt!==void 0&&Rt!==void 0&&Rt!==4){const e=zt.AudioSystem.instruments[Rt];console.log(pt.name);const t=e.parameterNames[-cm-1];console.log(pt.userData.cachedRotation),pt.userData.cachedRotation===void 0&&(pt.userData.cachedRotation=e.getDefault01(t)),console.log(pt.userData.cachedRotation),pt.userData.cachedRotation+=-hm.current_input.diffY*10,console.log(pt.userData.cachedRotation),pt.userData.cachedRotation=Math.min(Math.max(pt.userData.cachedRotation,0),1),console.log(pt.userData.cachedRotation),pt.userData.parameter===void 0?pt.userData.parameter={name:t,value:e.getParamValueFromNormRange(t,pt.userData.cachedRotation)}:(pt.userData.parameter.name=t,pt.userData.parameter.value=e.getParamValueFromNormRange(t,pt.userData.cachedRotation)),_D(Rt,t,pt.userData.parameter.value),pt.rotation.set(0,0,-pt.userData.cachedRotation*3.14*2)}Rt===void 0&&(um+=.02,ah.forEach((e,t)=>{const n=Math.sin(um*1+t)*6.28;console.log(n),e.rotation.set(0,0,n)})),am.setFromCamera(Yt,Ui),$t.time.value>0?$t.time.value-=.1:$t.time.value=0;const s=am.intersectObjects(ii.children);if(bl.render(ii,Ui),s.length!==0){let e;for(let a=0;a<s.length;a++)if(!(s[a].object.userData.skipInteraction||s[a].object.visible===!1)){e=s[a];break}if(e===void 0)return;if(e.object.userData.beat===-1){const a=e.object.geometry.attributes.melodyInstrumentID.array[e.instanceId]%5;Rt!==void 0&&(Pn[Rt].visible=!1),Pn[a].visible=!0,Rt=a;const c=zt.AudioSystem.instruments[Rt];ah.forEach((l,u)=>{const h=u<c.parameterNames.length;l.visible=h,h&&(l.userData.cachedRotation=c.getDefault01(c.parameterNames[u]),l.rotation.set(0,0,-l.userData.cachedRotation*3.14*2))}),console.log("SETCACHEDROTATION"),$t.time.value=1,$t.picked.value=e.instanceId+e.object.userData.beat*40,Yt.x=Yt.y=-2,z_(Rt);return}if(e.object.userData.knob!==void 0){cm=-e.object.userData.knob;const a=e.object.userData.color=Math.floor(Math.random()*4);e.object.material.color=new Te(Ln[a*3],Ln[a*3+1],Ln[a*3+2]),pt=e.object,Yt.x=Yt.y=-2;return}const t=e.object.userData.beat,n=e.instanceId;if($t.time.value=1,$t.picked.value=e.instanceId+t*40,Rt===void 0){zt.AudioSystem.playEmptyInstrument(),Yt.x=Yt.y=-2;return}let i=0;Eu.includes(n)?i=Eu.length-1-Eu.indexOf(n):wu.includes(n)?i=wu.length-1-wu.indexOf(n):console.log("there is no instance with given id");let r=e.object.geometry.attributes.melodyInstrumentID.array[n];r=r===Rt?4:Rt,e.object.geometry.attributes.melodyInstrumentID.array[n]=r,$t.melodyInstrumentID.value[t*40+n]=r;const o=zt.AudioSystem.addInstrumentOnPosition(r,t,n,i);r!==4&&zt.AudioSystem.playInstrumentAt(o),zt.Curve.geometryNeedsUpdate=!0,e.object.geometry.attributes.melodyInstrumentID.needsUpdate=!0,Yt.x=Yt.y=-2}}function So(s){O_=s,s?(bn.style.display="block",kn.style.display="block",sm.style.display="block",rm.style.display="block",om.style.display="flex"):(kn.style.display="none",bn.style.display="none",sm.style.display="none",rm.style.display="none",om.style.display="none")}function z_(s){const e=zt.AudioSystem.instruments[s];for(let t=0;t<Os.children.length;t++)Os.children[t].children[0].textContent="            ",Os.children[t].children[1].textContent="   ";Object.keys(e.parameters).forEach((t,n)=>{let i;t==="waveform"?i=uo[Math.floor(e.parameters[t].value)]:t==="noiseType"?i=il[Math.floor(e.parameters[t].value)]:i=e.parameters[t].value>5?e.parameters[t].value.toFixed(0):e.parameters[t].value.toPrecision(2),Os.children[n].children[0].textContent=t,Os.children[n].children[1].textContent=i}),U_.textContent=e.name}function _D(s,e,t){const n=zt.AudioSystem.instruments[s];Object.keys(n.parameters).forEach((i,r)=>{i===e&&(i==="waveform"?t=uo[Math.floor(t)]:i==="noiseType"?t=il[Math.floor(t)]:t=t>5?t.toFixed(0):t.toPrecision(2),Os.children[r].children[0].textContent=i,Os.children[r].children[1].textContent=t)}),U_.textContent=n.name}function vD(s){const e=zt.AudioSystem.getMelodyData(s);e.speed=zt.GlobalParameters.speed;let t=JSON.stringify(e);yD(t,"my_melody.txt","text/plain")}function yD(s,e,t){var n=document.createElement("a"),i=new Blob([s],{type:t});n.href=URL.createObjectURL(i),n.download=e,n.click()}function G_(s,e=!1){fetch(s).then(t=>t.json()).then(t=>{const n=t;zt.AudioSystem.setMelodyFromJsonData(n,e),n.speed!==void 0&&(zt.GlobalParameters.speed=n.speed,zt.camera.userData.speed=n.speed),n.melody.forEach(i=>{Xi[i.beat].geometry.attributes.melodyInstrumentID.array[i.id_on_beat]=i.instrument}),Xi.forEach(i=>{i.geometry.attributes.melodyInstrumentID.needsUpdate=!0}),zt.Curve.geometryNeedsUpdate=!0,Rt!==void 0&&Rt!==4&&z_(Rt)})}function Tl(s,e=!1){Xi.forEach((t,n)=>{for(let i=0;i<40;i++)t.geometry.attributes.melodyInstrumentID.array[i]=$t.melodyInstrumentID.value[n*40+i];t.geometry.attributes.melodyInstrumentID.needsUpdate=!0})}function xd(s){let e=document.getElementById("sheet_songList");s?(kn.removeEventListener("pointerdown",ch,!1),e.style.display="block",document.querySelectorAll("span").forEach(t=>{t.offsetWidth>250&&(console.log(t.offsetWidth),console.log(t.textContent),console.log(t.getAnimations()[0]),t.animate({transform:["translateX(0px)","translateX(-"+(t.offsetWidth-250)+"px)"]},{duration:2e3,iterations:1/0,direction:"alternate"}))})):(kn.addEventListener("pointerdown",ch,!1),e.style.display="none")}const xD="sleepwell";let Ge,Ni,Pr,Ea=!1;await SD().catch(s=>console.error(s));MD();mD(Pr,Ge.world);Ge.update();document.styleSheets[0].insertRule("canvas { outline:none; border:none; }",0);async function SD(){Ni=new Xo,Pr=new Xo;const s=new lg().setPath("/models/"),e=new sg().setPath("/textures/"),t=await e.loadAsync("rgbw.png");t.flipY=!1,t.colorSpace=_t;const i=(await s.loadAsync("TO_self.gltf")).scene.children[0];i.name="TO_SELF",i.material=new Ds({color:16777215}),i.material.roughness=0,i.material.map=t,Ni.add(i),Pr.add(i.clone());const r=await s.loadAsync("knob_mat.gltf");Ni.add(r.scene.children[0]);const o=await e.loadAsync("w_k.png");o.flipY=!1,o.colorSpace=_t;const a=await s.loadAsync("knobs_self.gltf");a.scene.traverse(v=>{v.isMesh&&(v.material=new Ds({color:16777215}),v.material.roughness=0,v.material.map=o)}),Ni.add(a.scene),Pr.add(a.scene.clone());const c=await s.loadAsync("musicSheetTris1.gltf"),l=await s.loadAsync("sheet_positions.gltf");console.log(c);const h=(await s.loadAsync("beam.gltf")).scene.children[0];h.name="VISUAL_QUAD",h.material=new Ds({color:16777215}),h.roughness=0,h.material.side=Tn,h.material.transparent=!0,h.material.opacity=.5,h.material.blending=Oo,h.material.depthWrite=!1;const d=await e.loadAsync("fractal1.png");d.wrapS=mn,d.wrapT=mn,d.repeat=new xe(1,1),h.material.map=d,Ni.add(h),Pr.add(c.scene),Pr.add(l.scene);const f=await s.loadAsync("hand_w_fingers.gltf");for(f.scene.children[0].name="HAND";f.scene.children.length>1;)f.scene.children[0].attach(f.scene.children[1]);f.scene.children[0].animations=f.animations,f.scene.children[0].children[0].material=new Ds({color:16777215,emissive:3355443}),f.scene.children[0].children[0].material.roughness=0,Ni.add(f.scene.children[0]);const _=(await s.loadAsync("electricity.gltf")).scene.children[0];_.name="ELECTRICITY",_.material=new Ds({color:16777215}),_.roughness=0,_.material.side=Tn,_.material.transparent=!0,_.material.opacity=.5,_.material.blending=Oo,_.material.depthWrite=!1;const g=await e.loadAsync("electric.png");g.wrapS=mn,g.wrapT=mn,g.repeat=new xe(1,1),_.material.map=g,Ni.add(_);const x=(await s.loadAsync("bomb.gltf")).scene.children[0];x.name="BOMB",x.material=new Ds({color:16777215}),x.roughness=0,x.material.side=Tn,x.material.transparent=!0,x.material.opacity=1,x.material.blending=Oo,x.material.depthWrite=!1,Ni.add(x)}function MD(){Ge=new cD(Ni)}function Sd(){Ea=!0,Ge.world.paused=!1}function ys(s){let e=document.getElementById("startScreen");s?e.style.display="block":e.style.display="none"}function Md(s){let e=document.getElementById("codeEntering");s?e.style.display="block":e.style.display="none"}function El(s){let e=document.getElementById("pauseScreen");s?e.style.display="block":e.style.display="none"}function bd(s){let e=document.getElementById("songList");s?(e.style.display="block",document.querySelectorAll("span").forEach(t=>{t.offsetWidth>250&&(console.log(t.offsetWidth),console.log(t.textContent),console.log(t.getAnimations()[0]),t.animate({transform:["translateX(0px)","translateX(-"+(t.offsetWidth-250)+"px)"]},{duration:2e3,iterations:1/0,direction:"alternate"}))})):e.style.display="none"}function ar(s){let e=document.getElementById("playScreen");s?e.style.display="flex":e.style.display="none",Ge.world.songEditingUnlocked&&Ge.world.editMode===!0?document.getElementById("editSongButton").style.display="block":document.getElementById("editSongButton").style.display="none"}document.getElementById("chooseSong").addEventListener("click",function(){ys(!1),bd(!0)});document.getElementById("submitButton").addEventListener("click",function(){document.getElementById("input_text").value===xD&&(Ge.world.songEditingUnlocked=!0,Md(!1),So(!0))});function bD(s){console.log(s.target),console.log(s.target.dataset.url),bd(!1),ar(!0),G_(s.target.dataset.url),Ge.world.Curve.placeInteractive(Ge.world,1),Ge.world.Curve.placeInteractive(Ge.world,2),Sd()}function TD(s){xd(!1),Ge.world.AudioSystem.resetMelody(),Tl(),G_(s.target.dataset.url,!0),this.geometryNeedsUpdate=!0,this.updateGeometry(Ge.world)}document.querySelectorAll("div.melody").forEach(s=>{s.addEventListener("click",bD)});document.querySelectorAll("div.sheet_melody").forEach(s=>{s.addEventListener("click",TD)});document.getElementById("continueBtn").addEventListener("click",function(){El(!1),ar(!0),Sd()});document.getElementById("makeSong").addEventListener("click",function(){ys(!1),Ge.world.songEditingUnlocked?So(!0):Md(!0)});document.getElementById("editSongButton").addEventListener("click",function(){ar(!1),Ge.world.paused=!0,Ge.world.AudioSystem.instruments.forEach(s=>{s.releaseAll()}),So(!0)});document.getElementById("resetAndExitToMenu").addEventListener("click",function(){Ea=!1,El(!1),ys(!0),Ge.world.editMode=!1,Ge.resetGameState(),Tl()});document.getElementById("pausebtn").addEventListener("click",function(){ar(!1),El(!0),Ge.world.paused=!0});document.getElementById("playFromSheetBtn").addEventListener("click",function(){So(!1),Ge.world.editMode=!0,ar(!0),Sd()});document.getElementById("closeSheetBtn").addEventListener("click",function(){So(!1),Ea?El(!0):ys(!0)});document.getElementById("rtmm").addEventListener("click",function(){bd(!1),ys(!0)});document.getElementById("sheet_goback").addEventListener("click",function(){xd(!1)});document.getElementById("rtm").addEventListener("click",function(){Md(!1),ys(!0)});document.getElementById("gotomenu").addEventListener("click",function(){Ea=!1,Ge.world.showEndScreen(!1),ys(!0),Ge.world.editMode=!1,Ge.resetGameState(),Tl()});document.getElementById("gotomenu_w").addEventListener("click",function(){Ea=!1,Ge.resetGameState(),Tl(),Ge.world.showWinScreen(!1),ys(!0)});document.getElementById("savemelody").addEventListener("click",function(){vD()});document.getElementById("readFromJson").addEventListener("click",function(){xd(!0),document.getElementById("scaleSelect").value=Ge.world.AudioSystem.getActiveScale();const s=Ge.world.AudioSystem.getCurrentTonicAndOctave();document.getElementById("tonicSelect").value=s.tonic,document.getElementById("octaveSelect").value=s.octave,document.getElementById("speedSelect").value=Ge.world.GlobalParameters.speed});document.getElementById("scaleSelect").onchange=s=>{Ge.world.AudioSystem.setActiveScale(s.target.value)};document.getElementById("tonicSelect").onchange=s=>{Ge.world.AudioSystem.setTonicAndOctave(s.target.value,void 0)};document.getElementById("octaveSelect").onchange=s=>{console.log(s.target.value),Ge.world.AudioSystem.setTonicAndOctave(void 0,s.target.value)};document.getElementById("speedSelect").onchange=s=>{console.log(s.target.value),console.log(Ge.world.GlobalParameters.speed),Ge.world.GlobalParameters.speed=s.target.value,console.log(Ge.world.GlobalParameters.speed),Ge.world.camera.userData.speed=Ge.world.GlobalParameters.speed};Ge.world.showEndScreen=function(s){ar(!1);let e=document.getElementById("endScreen");s?e.style.display="block":e.style.display="none"};Ge.world.showWinScreen=function(s){ar(!1);let e=document.getElementById("winScreen");s?e.style.display="block":e.style.display="none"};Ge.world.updateProgressBar=function(s){};H_();function H_(){requestAnimationFrame(H_),gD(),Ge.update()}document.addEventListener("wheel",function(e){e.ctrlKey&&e.preventDefault()},{passive:!1});
